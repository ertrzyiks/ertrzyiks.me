// Same eval harness as extractActionItems.eval.test.ts (see runFixtureSuite.ts), run against
...
// current prompt got it wrong). Green here means the prompt now agrees with the human's
// correction; once it does, move the fixture over to fixtures.ts as a regular regression fixture
// and delete its entry from reviewed-fixtures.json (or leave it — a green fixture here does no
// harm, it just stops being a to-do).
//

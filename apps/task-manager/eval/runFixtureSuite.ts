...
// review`, see that script's header) run the exact same fixture -> extraction -> assertions
// shape, just against a different fixture list and (in principle) a different extractor — pulled
// out so neither file has to duplicate it.

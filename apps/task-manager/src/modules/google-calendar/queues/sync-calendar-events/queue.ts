...
// ../../../todoist/queues/sync-todoist/queue.ts exactly, same "runs in the cloud, no
...
// Mirrors ../../todoist/queues/sync-todoist/queue.ts's TodoistJobLike/
// TodoistJobsQueue, typed to the sync-calendar-events payload instead — kept as a separate

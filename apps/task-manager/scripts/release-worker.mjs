...
// lmStudio.ts reads its system prompt from src/modules/email-processing/queues/extract-action-items/prompts/ via a path
...
const PROMPTS_SRC_DIR = "src/modules/email-processing/queues/extract-action-items/prompts";
